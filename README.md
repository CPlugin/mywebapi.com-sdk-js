...
```bash
bun add @cplugin/saas-webapi-client
# or: npm / pnpm install @cplugin/saas-webapi-client
```
...
```typescript
import { CPluginWebApiClient, ApiError, collectAll } from '@cplugin/saas-webapi-client';
...
import { paginate } from '@cplugin/saas-webapi-client';
...
```typescript
import { ApiError } from '@cplugin/saas-webapi-client';
