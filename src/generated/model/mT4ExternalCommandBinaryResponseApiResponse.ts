...
import type { MT4ExternalCommandBinaryResponse } from './mT4ExternalCommandBinaryResponse';
 ...
 */
export interface MT4ExternalCommandBinaryResponseApiResponse {
  /** v2 DTO for the response of `ExternalCommandBinary` (sidecar-only). */
  data?: MT4ExternalCommandBinaryResponse | null;
  /**
